  ...
  <div class="min-h-screen bg-gray-900 text-gray-100 font-sans">
    <div class="max-w-6xl mx-auto px-6 py-12">
      ...
      <div
        ...
        class="rounded-lg border border-gray-800 bg-gray-900 p-8"
      >
        <!-- Header -->
        <div class="mb-6">
        ...
        <div class="flex flex-wrap gap-6 text-sm text-gray-300">
          ...
          <div class="flex items-center gap-2">
            <svg class="w-4 h-4 text-yellow-400 relative top-[-2px]" viewBox="0 0 16 16"
                 aria-hidden="true">
              <path
          ...
          <!-- Forks -->
          <div class="flex items-center gap-2">
            <svg class="w-4 h-4 text-gray-400 relative top-[-1px]" viewBox="0 0 16 16"
                 aria-hidden="true">
              <path
          ...
          <div v-if="repository.language" class="flex items-center gap-2">
            <span
              class="inline-block w-3 h-3 rounded-full bg-indigo-400 relative top-[-1px]"></span>
